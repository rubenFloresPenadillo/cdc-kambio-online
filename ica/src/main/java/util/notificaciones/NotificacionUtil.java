...
public class NotificacionUtil {
	...
	public static final String HOST_EMAIL = "mail.icambio.pe"; // host o servidor de correo
    public static final String NOMBRE_SERVICIO = "Icambio"; // nombre de propietario
    public static final String EMAIL_SERVICIO = "no-reply@icambio.pe"; // propietario de cuenta
    public static final String PASSWORD= "Icambio2022@"; // password de propietario
    public static final String EMAIL_CONTACTO_COMERCIO = "ventas@icambio.pe"; // propietario de cuenta, correo del comercio a donde le llegara el correo de contacto del cliente
	...
	public static void enviarCorreo (Map<String, String> datamodel, String nombrePlantilla, String asunto, String correoDestino) {
		...
		final String  IMAGEN_LOGO = "logoIcambio.png";

//		String from = "casadecambioelalfarero.portal@gmail.com"; // Icambio
		String valorDelFrom = "Icambio";
...
//			throw new RuntimeException(e);
	...
	public static void enviarCorreoAComercio (String nombrePlantilla, String asunto, String cuerpoMensaje) {
		...
		String valorDelFrom = "Contacto - Icambio";
		Properties props = new Properties();
		props.put("mail.transport.protocol", "smtp");
		props.put("mail.smtp.starttls.enable", "true");
		props.put("mail.smtp.host", HOST_EMAIL);
