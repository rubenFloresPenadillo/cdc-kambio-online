...
@ManagedBean(name="reportesPrincipalBean")
@ViewScoped
public class ReportesPrincipalBean {

	private String valorNombre;
	
	public ReportesPrincipalBean() {
		
	}
	
    /**
     * Realiza su ejecuci�n despues del Constructor de la clase ControlBean.
     */
    @PostConstruct
    public void init() {
