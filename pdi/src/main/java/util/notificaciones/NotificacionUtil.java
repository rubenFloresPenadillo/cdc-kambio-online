...
public class NotificacionUtil {
    ...
    public static final String NOMBRE_SERVICIO = "Preciso"; // nombre de propietario
	...
	public static void enviarCorreo (Map<String, String> datamodel, String nombrePlantilla, String asunto, String correoDestino) {
		...
		final String  IMAGEN_LOGO = "logoPreciso.png";

//		String from = "casadecambioelalfarero.portal@gmail.com";
		String valorDelFrom = "Preciso";
...
//			throw new RuntimeException(e);
	...
	public static void enviarCorreoAComercio (String nombrePlantilla, String asunto, String cuerpoMensaje) {
		...
		String valorDelFrom = "Contacto - Preciso";
		Properties props = new Properties();
		props.put("mail.transport.protocol", "smtp");
		props.put("mail.smtp.starttls.enable", "true");
		props.put("mail.smtp.host", HOST_EMAIL);
