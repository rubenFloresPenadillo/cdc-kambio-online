...
$( document ).ready(function() {
	...
	var idIndicadorPepIni = document.getElementById("idFormDatosPersonales:idIndicadorPep").value;
	if (idIndicadorPepIni == '1') {
		$('#idInputPep').bootstrapToggle('on');
	}else{
		$('#idInputPep').bootstrapToggle('off');
	}
...
function enviar(event) {
    ...
    if (idTxtNombre1 == null || idTxtNombre1 == ''){
    	...
    	event.preventDefault();
    } else if (idTipoDocumento == 1 && idTxtDocumento.length != 8){ 
    	$("#idMensajeResultadoDocumento").text("La longitud del DNI debe ser de 8 digitos.");
    	$("#idMensajeResultadoDocumento").addClass( "alert alert-danger claseMensajeResultado" )
        $("#idMensajeResultadoDocumento").removeClass( "hidden" );
    	$("#idMensajeResultadoDocumento").fadeOut(6000);
    	$("[id='idFormDatosPersonales:idTxtDocumento']").focus();
    	$("[id='idFormDatosPersonales:idTxtDocumento']").addClass( "claseErrorFormulario" );
    	event.preventDefault();
    } else if ( idTipoDocumento == 1 && !regex.test(idTxtDocumento) ){
    	$("#idMensajeResultadoDocumento").text("El DNI solo debe contener números.");
    	$("#idMensajeResultadoDocumento").addClass( "alert alert-danger claseMensajeResultado")
        $("#idMensajeResultadoDocumento").removeClass( "hidden" );
    	$("#idMensajeResultadoDocumento").fadeOut(6000);
    	$("[id='idFormDatosPersonales:idTxtDocumento']").focus();
