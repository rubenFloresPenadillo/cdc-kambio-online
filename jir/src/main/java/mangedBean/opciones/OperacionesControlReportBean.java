...
//    }
    ...
    if (ValidacionesString.esNuloOVacio(resultadoProcesoError))	{
        ...
        b1.setCellValue(new HSSFRichTextString("Fecha de Creación"));
        ...
        g1.setCellValue(new HSSFRichTextString("Razón Social"));
        h1.setCellValue(new HSSFRichTextString("Código de Operación Bancaria"));
        i1.setCellValue(new HSSFRichTextString("Cliente Envia"));
        j1.setCellValue(new HSSFRichTextString("Cliente Recibe"));
        k1.setCellValue(new HSSFRichTextString("Operación"));
        l1.setCellValue(new HSSFRichTextString("Tipo de Cambio"));
        m1.setCellValue(new HSSFRichTextString("Cupón Aplicado"));
        n1.setCellValue(new HSSFRichTextString("Desct. Cupón"));
        o1.setCellValue(new HSSFRichTextString("Estado"));   
        p1.setCellValue(new HSSFRichTextString("Motivo Cancelación"));
        q1.setCellValue(new HSSFRichTextString("Fecha Cancelación"));
        r1.setCellValue(new HSSFRichTextString("Usuario Cancelación"));        
        ...
        for(TpOperaClienDto temp : listaOperacionesControl) {
       	 ...
       	 row.createCell(8).setCellValue(new HSSFRichTextString(temp.getMonEnvi()+" "+( temp.getIndCompVent() == 0 ? "Dólares" : "Soles" )));
       	 row.createCell(9).setCellValue(new HSSFRichTextString(temp.getMonReci()+" "+( temp.getIndCompVent() == 1 ? "Dólares" : "Soles" )));
