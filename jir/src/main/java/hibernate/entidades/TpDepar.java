...
/**
 * TpDepar generated by hbm2java
 */
@Entity
@Table(name = "tp_depar", schema = "public")
public class TpDepar implements java.io.Serializable {
	...
	public TpDepar(Integer codDepa, String desDepa, Integer indEsta, String usuApliCrea, Date fecCreaRegi) {
	...
	@Column(name = "des_depa", nullable = false, length = 50)
