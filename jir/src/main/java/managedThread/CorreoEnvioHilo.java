...
public class CorreoEnvioHilo implements Runnable {
	...
	private String monedaClienteEnvia;
	private BigDecimal montoOperacionClienteEnvia;
	private String monedaClienteRecibe;
	private BigDecimal montoOperacionClienteRecibe;
...
//	}
	...
	public void enviarCorreoRegistroOperacion() {
    	...
    	datamodel.put("parametroDominioWeb", parametroDominioWeb);
    	datamodel.put("parametroComercio", parametroComercio);
    	datamodel.put("parametroMonedaClienteEnvia", monedaClienteEnvia);
    	datamodel.put("parametroMontoOperacionClienteEnvia", String.valueOf(montoOperacionClienteEnvia));
    	datamodel.put("parametroMonedaClienteRecibe", monedaClienteRecibe);
    	datamodel.put("parametroMontoOperacionClienteRecibe", String.valueOf(montoOperacionClienteRecibe));
