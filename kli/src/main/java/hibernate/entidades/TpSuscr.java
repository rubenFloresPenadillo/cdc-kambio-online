...
/**
 * TpSuscr generated by hbm2java
 */
@Entity
@Table(name = "tp_suscr", schema = "public")
public class TpSuscr implements java.io.Serializable {
	...
	public TpSuscr(Integer codSusc, Integer indEsta, String usuApliCrea, Date fecCreaRegi) {
	...
	public TpSuscr(Integer codSusc, String emaSusc, Integer indEsta, String usuApliCrea, Date fecCreaRegi,
	...
	@Column(name = "cod_susc", unique = true, nullable = false)
	...
	@Column(name = "ema_susc", length = 100)
