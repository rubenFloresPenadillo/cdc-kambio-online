...
//	}
	...
	public void enviarCorreoRestablecerCuenta() {
    	...
    	LoggerUtil.getInstance().getLogger().info("token "+token);
    	String asunto = "Solicitud de restablecimiento de contrase馻 - Kambio Online.";
	...
	public void enviarCorreoRegistroOperacion() {
    	...
    	String asunto = "Operaci贸n con c贸digo "+codigoUnicoOperacion+ " registrada, pendiente de verificaci贸n.";
    ...
    public void enviarCorreoOperacionFinalizada() {
    	...
    	datamodel.put("parametroNombre", nombreCliente);
    	datamodel.put("parametroCodigoOperacion", codigoUnicoOperacion);
    	String asunto = "Operaci贸n con c贸digo "+codigoUnicoOperacion+ " finalizada con 茅xito.";
    ...
    public void enviarCorreoOperacionCancelada() {
    	...
    	if(ValidacionesString.esNuloOVacio(codigoUnicoOperacion)) {
        	...
        	asunto = "Operaci贸n cancelada.";	
    	}else {
        	datamodel.put("parametroCodigoOperacion", codigoUnicoOperacion);
        	asunto = "Operaci贸n con c贸digo "+codigoUnicoOperacion+ " ha sido cancelada.";
    	}
...
//    	String asunto = "Activaci髇 de tu cuenta - Kambio Online.";
	...
	public void enviarCorreoRegistroReclamoAdmin() {
    	...
    	String asunto = "Se registr贸 una Queja o Reclamo- Kambio Online.";
