...
//			resultado.getTpBanco().setCodBanc((Integer) temporal[6]);
	...
	public List<TpOperaClienDto> getOperacionesCliente(TpOperaClienDto tpOperaClienDto) {
		...
		entidad.getTpClien().setCodClie(tpOperaClienDto.getTpClien().getCodClie());
		entidad.setCodUnicOperClie(tpOperaClienDto.getCodUnicOperClie());

		List<Object[]> listaTemporal = daoOperacionCliente.getOperacionesCliente(entidad);
