...
//	$('#modalComunicadoPrincipal').modal('show');
...
function enlaceWhatsapp() {
	 var win = window.open('https://api.whatsapp.com/send?phone=51981319152&text=Hola,%20solicito%20información%20acerca%20de%20', '_blank');
	 win.focus();  
}
