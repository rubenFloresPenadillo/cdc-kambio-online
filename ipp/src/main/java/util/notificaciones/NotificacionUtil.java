...
public class NotificacionUtil {
	...
	public static final String HOST_EMAIL = "mail.casadecambiodigitalperu.com"; // host o servidor de correo
    public static final String NOMBRE_SERVICIO = "Rhaak"; // nombre de propietario
    public static final String EMAIL_SERVICIO = "no-reply@casadecambiodigitalperu.com"; // propietario de cuenta
    public static final String PASSWORD= "Rhaak2021@"; // password de propietario
    public static final String EMAIL_CONTACTO_COMERCIO = "ventas@rhaak.com"; // propietario de cuenta
    public static final String EMAIL_PERSONAL_COMERCIO = "casadecambioelalfarero@gmail.com"; // email personal comerciochrist.albert17@gmail.com
...
//			throw new RuntimeException(e);
	...
	public static void enviarCorreoAComercio (String nombrePlantilla, String asunto, String cuerpoMensaje) {
		...
		String valorDelFrom = "Contacto - Rhaak";
		Properties props = new Properties();
		props.put("mail.transport.protocol", "smtp");
		props.put("mail.smtp.starttls.enable", "true");
		props.put("mail.smtp.host", HOST_EMAIL);
