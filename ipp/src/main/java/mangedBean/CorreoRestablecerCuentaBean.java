...
//    	String asunto = "Activación de tu cuenta - Rhaak.";
		...
		if (temp == null) {
			...
			if (PerfilesType.CLIENTE.getIdElemento().equals(temp.getCodPerfUsua())) {
				...
				if (EstadosCuentaUsuarioType.ESTADO_CUENTA_USUARIO_REGISTRADA.getIdElemento().equals(temp.getCodEstaCuenUsua()) || 
					...
					String encriptado = EnmascaraUtil.encriptar(temp.getIdeUsuaEmai());
			        ...
			        usuarioFormulario.setUsuApliModi(temp.getIdeUsuaEmai());
...
//						enviarCorreoActivacionCuenta(enlaceActivaCuenta.toString());
						...
						CorreoEnvioHilo hiloCorreoRestablecerCuentaBean1 = new CorreoEnvioHilo(PlantillasType.PLANTILLA_ENVIAR_ENLACE_RESTABLECER_CUENTA, "hiloCorreoRestablecerCuentaBean1",  temp.getIdeUsuaEmai(), null, null, enlaceRestableceCuenta.toString());
