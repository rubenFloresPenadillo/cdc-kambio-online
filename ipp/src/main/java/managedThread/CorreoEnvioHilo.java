...
//	}
	...
	public void enviarCorreoActivacionCuentaCodigo() {
    	Map<String, String> datamodel = new HashMap<String, String>();
    	if(ValidacionesString.esNuloOVacio(nombreCliente)) {
    		nombreCliente= CadenasType.COMA_ESPACIO.getValor();
    	}
    	...
    	String asunto = "Activación de tu cuenta - Código de Verificación | Rhaak.";
	...
	public void enviarCorreoRestablecerCuenta() {
    	...
    	LoggerUtil.getInstance().getLogger().info("token "+token);
    	String asunto = "Solicitud de restablecimiento de contraseña - Rhaak.";
...
//    	String asunto = "Activación de tu cuenta - Rhaak.";
	...
	public void enviarCorreoRegistroReclamoCliente() {
    	...
    	String asunto = "Registro de Queja o Reclamo - Rhaak.";
	...
	public void enviarCorreoRegistroReclamoAdmin() {
    	...
    	String asunto = "Se registró una Queja o Reclamo- Rhaak.";
