...
public class NotificacionUtil {
    ...
    public static final String NOMBRE_SERVICIO = "Casa de Cambio Multicambio"; // nombre de propietario
    public static final String PASSWORD= "D4nielD4niel123456"; // password de propietario
    public static final String EMAIL_CONTACTO_COMERCIO = "ventas@multicambio.pe"; // propietario de cuenta
...
//		String from = "casadecambioelalfarero.portal@gmail.com"; // Casa de Cambio Multicambio
		String valorDelFrom = "Casa de Cambio Multicambio";
...
//			throw new RuntimeException(e);
	...
	public static void enviarCorreoAComercio (String nombrePlantilla, String asunto, String cuerpoMensaje) {
		...
		String valorDelFrom = "Contacto - Casa de Cambio Multicambio";
		Properties props = new Properties();
		props.put("mail.transport.protocol", "smtp");
		props.put("mail.smtp.starttls.enable", "true");
		props.put("mail.smtp.host", "smtp.gmail.com");
