...
public class NotificacionUtil {
    ...
    public static final String NOMBRE_SERVICIO = "Casa de Cambio Hmafg"; // nombre de propietario
    public static final String PASSWORD= "D4nielD4niel123456"; // password de propietario
    public static final String EMAIL_CONTACTO_COMERCIO = "ventas@hmafg.com"; // propietario de cuenta
...
//		String from = "casadecambioelalfarero.portal@gmail.com"; // Casa de Cambio Hmafg
		String valorDelFrom = "Casa de Cambio Hmafg";
...
//			throw new RuntimeException(e);
	...
	public static void enviarCorreoAComercio (String nombrePlantilla, String asunto, String cuerpoMensaje) {
		...
		String valorDelFrom = "Contacto - Casa de Cambio Hmafg";
		Properties props = new Properties();
		props.put("mail.transport.protocol", "smtp");
		props.put("mail.smtp.starttls.enable", "true");
		props.put("mail.smtp.host", "smtp.gmail.com");
