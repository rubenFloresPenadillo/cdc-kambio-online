...
//	}
	...
	public void enviarCorreoActivacionCuentaCodigo() {
    	...
    	String asunto = "Activación de tu cuenta - Código de Verificación | Casa de Cambio Hmafg.";
	...
	public void enviarCorreoRestablecerCuenta() {
    	...
    	LoggerUtil.getInstance().getLogger().info("token "+token);
    	String asunto = "Solicitud de restablecimiento de contraseña - Casa de Cambio Hmafg.";
...
//    	String asunto = "Activación de tu cuenta - Casa de Cambio Hmafg.";
	...
	public void enviarCorreoRegistroReclamoCliente() {
    	...
    	String asunto = "Registro de Queja o Reclamo - Casa de Cambio Hmafg.";
	...
	public void enviarCorreoRegistroReclamoAdmin() {
    	...
    	String asunto = "Se registró una Queja o Reclamo- Casa de Cambio Hmafg.";
