...
function enlaceWhatsappVerificacion(codigoOperacion) {
	 var win = window.open('https://api.whatsapp.com/send?phone=51992951162&text=Hola,%20solicito%20información%20de%20mi%20operación%20con%20código%20'+codigoOperacion, '_blank');
	 win.focus();  
}